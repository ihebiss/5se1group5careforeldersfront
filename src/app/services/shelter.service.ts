...
export class ShelterService {
  ...
  private url ='http://192.168.13.130:8087/' ;
  ...
  affectHomelessToShelter(idHomeless: number, idShelter: number) {
    ...
    return this.http.put('http://192.168.13.130:8087/Homeless/affect/' + idHomeless + "/" + idShelter, body);
}
  ...
  addCauseToShelter(shelterId: number, causeData: any): Observable<any> {
    return this.http.post(`http://192.168.13.130:8087/shelter/addCauseToShelter/${shelterId}`, causeData, { responseType: 'text' })
      .pipe(
