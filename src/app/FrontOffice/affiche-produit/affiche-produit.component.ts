...
export class AfficheProduitComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.getProduits();
    this.getProduitsFavoris();  // Appeler la méthode pour récupérer les produits lors de l'initialisation
  }
  ...
  getProduitsFavoris(): void {
    this._shared.getProduitsFavoris(this.idUtilisateur).subscribe(
      produitsFavoris => {
  ...
  ajouterAuxFavoris(produit: any): void {
    this._shared.ajouterProduitAuxFavoris(this.idUtilisateur, produit.idProduit).subscribe(
      () => {
  ...
  supprimerDesFavoris(produit: any): void {
    this._shared.supprimerProduitDesFavoris(this.idUtilisateur, produit.idProduit).subscribe(
      () => {
